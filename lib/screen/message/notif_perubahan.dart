...
class NotifPerubahanPage extends StatelessWidget {
  final String judulBantuan;
  final String deskripsi;
  final String waktu;

  const NotifPerubahanPage({
    super.key,
  ...
  Widget build(BuildContext context) {
    // 🔹 Tentukan logo berdasarkan judul pesan
    IconData iconData;
    ...
    if (lowerJudul.contains('pembayaran')) {
      ...
      gradientColors = const [Color(0xFFB2435E), Color(0xFFEB7961)];
      ...
      gradientColors = const [Color(0xFF888888), Color(0xFFCCCCCC)];
    }
        ...
        child: Center(
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              boxShadow: [
                BoxShadow(
                  color: Colors.black.withOpacity(0.08), // 🔹 Shadow lembut
                  blurRadius: 10,
                  spreadRadius: 2,
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        gradient: const LinearGradient(
                          colors: [Color(0xFFB2435E), Color(0xFFEB7961)],
                          begin: Alignment.topLeft,
                          end: Alignment.bottomRight,
                        ),
                      ),
