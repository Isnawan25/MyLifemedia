...
class HomePreviewScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (_) => PromotionsCubit(PromotionService())..fetchPromotions(),
      child: const _HomePreviewView(),
    );
  }
}

class _HomePreviewView extends StatelessWidget {
  const _HomePreviewView();
